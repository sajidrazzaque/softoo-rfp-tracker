...
rem NOTE: claude is a .cmd shim on Windows, so it MUST be invoked with CALL,
rem otherwise control never returns to this script.
...
if not "!RC!"=="0" (
  ...
  echo Exit 1 commonly means claude is not signed in in this shell, or a flag was rejected. >> "!LOG!" 2>&1
